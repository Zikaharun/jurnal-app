This project is OOP project simple to create, delete, and find by id. This project without connect to the database, only use array to accommodate the data and session to temporary memory.
